			...
			<div className="flex flex-col-reverse md:flex-row gap-8">
				<main className="md:w-3/4">
					<article className="article-content prose prose-sm sm:prose lg:prose-lg xl:prose-xl prose-indigo">
						...
						{meta.date && (
							<p className="text-gray-500 mb-4">投稿日: {new Date(meta.date).toLocaleDateString("ja-JP")}</p>
						)}
						...
						{meta.description && <p className="text-gray-700 italic mb-6">{meta.description}</p>}
						<Post />
					</article>
				</main>
