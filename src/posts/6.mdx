...
分散システムやマイクロサービスアーキテクチャでは、複数のサービスにまたがるトランザクション管理が課題です。
...
この記事の内容を解説したスライドを公開しています。

- [Sagaパターン入門](https://speakerdeck.com/nikawa2161/sagapatanru-men)
- [Sagaパターン入門（続編）](https://speakerdeck.com/nikawa2161/sagapatanru-men-sok-bian)
